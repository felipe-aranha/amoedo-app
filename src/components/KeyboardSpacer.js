...
export class KeyboardSpacer extends Component{
  ...
  render() {
    const heightArea = this.props.platform ? Platform.OS == this.props.platform ? this.state.keyboardSpace : 0 : this.state.keyboardSpace;
    return (
      <View style={[styles.container, { height: heightArea}, this.props.style]} />);
  }
}